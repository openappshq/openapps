...
function Model({ input, selected, lighting = true, reducedMotion, onPress, onRelease }: Props) {
  const gltf = useLoader(GLTFLoader, "/keyboard/openklack.glb", configureLoader);
  const [base, rgb] = useLoader(TextureLoader, ["/keyboard/base.png", "/keyboard/rgb.png"]);
