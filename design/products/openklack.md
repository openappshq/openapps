...
Home: mark, sound toggle, Settings; current sound and volume above a fixed 3D keyboard.
...
Browser sound starts off and requires a gesture; shortcuts and form controls retain normal behavior.
