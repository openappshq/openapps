...
/// (`MACPAPER_UPDATE_TEST=1`, which also gives them their own bundle
...
extension UpdateTesting {
    ...
    private static let action = ProcessInfo.processInfo.environment["MACPAPER_UPDATE_TEST_ACTION"]
    ...
    private static func report(_ line: String) {
        FileHandle.standardError.write(Data("macpaper-update-test: \(line)\n".utf8))
    }
    #else
    @MainActor
    static func updateIsReady(installNow: @escaping @MainActor () -> Void, version: String) {}
