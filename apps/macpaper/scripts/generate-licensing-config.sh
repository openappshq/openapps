...
# button opens the website's macPaper page (OPENAPPS_BUY_URL, default
# https://openapps.space/macpaper/), the single place for the price; "Contact
# support" on a revoked license opens OPENAPPS_SUPPORT_URL (default the
# page's questions section; empty hides the link). Product IDs are public
...
buy_url="${OPENAPPS_BUY_URL:-https://openapps.space/macpaper/}"
support_url="${OPENAPPS_SUPPORT_URL-https://openapps.space/macpaper/#questions}"
...
enum LicensingConfig {
    ...
    /// The website's macPaper page; nil disables the buy button ("coming soon").
