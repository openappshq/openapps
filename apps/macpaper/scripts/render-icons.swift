...
let resources = root.appendingPathComponent("Sources/MacPaper/Resources")
...
let iconset = fileManager.temporaryDirectory.appendingPathComponent("macPaper-\(UUID().uuidString).iconset")
