...
/// (openapps-updater, openapps-licensing, apps/hertz, apps/macpaper); only
/// `prefix` differs. Keep them identical otherwise. macPaper's preview
/// harness keeps its throwaway suite the same way (PreviewHarness.swift).
final class TemporaryDefaults: @unchecked Sendable {
    ...
    /// none may be.
    static let prefix = "space.openapps.macpaper."
