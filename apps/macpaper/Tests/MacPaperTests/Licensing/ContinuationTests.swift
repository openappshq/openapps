...
struct ContinuationTests {
    ...
    func retainedBindingAfterExpiry() async {
        ...
        let grain = Binding<Double>(get: { model.edited.grain }, set: { model.edited.grain = $0 })
        let generator = Binding<Generator>(get: { model.edited.generator }, set: { model.edited.generator = $0 })
        ...
        generator.wrappedValue = .solid(SolidParameters(color: RGBAColor(hex: 0x123456)))
