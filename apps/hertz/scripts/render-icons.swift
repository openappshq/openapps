...
let resources = root.appendingPathComponent("Sources/Hertz/Resources")
...
let iconset = fileManager.temporaryDirectory.appendingPathComponent("Hertz-\(UUID().uuidString).iconset")
