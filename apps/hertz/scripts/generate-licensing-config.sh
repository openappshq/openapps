...
# button opens the website's Hertz page (OPENAPPS_BUY_URL, default
# https://openapps.space/hertz/), the single place for the price. Product IDs
...
buy_url="${OPENAPPS_BUY_URL:-https://openapps.space/hertz/}"
...
enum LicensingConfig {
    ...
    /// The website's Hertz page; nil disables the buy button ("coming soon").
