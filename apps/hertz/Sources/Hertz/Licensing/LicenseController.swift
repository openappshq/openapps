...
/// exposes state for the UI and tells the app whether the readings may run.
///
...
final class LicenseController {
    ...
    /// Runs whenever the state may have changed (readings on/off, badge).
    ...
    /// The pill in the dashboard header and the settings title bar, while
    /// not simply licensed. The end of the trial is said here and by the
    /// dashboard's card; nothing opens on its own.
    var badge: LicenseBadge.Label? {
        LicenseBadge.label(
            for: state,
