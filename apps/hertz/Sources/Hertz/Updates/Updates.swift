...
/// Hertz's instance of the shared updater (RELEASES.md, "In-app updater"):
...
final class Updates {
    ...
    /// Binds what the footer and the menu bar read. The hint closure reads
...
extension UpdateHint {
    /// What the footer says about a phase: nothing while idle, checking, up
