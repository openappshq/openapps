/**
 * The deck's three states as three still frames: the pill at rest, the fan
 * when the pointer reaches the edge, one note out. Drawn in CSS with the
      ...
      {states.map(([state, label]) => (
        <li key={state}>
          <span className="on-frame" data-state={state} aria-hidden="true">
            ...
            <span className="on-pill">
              <span className="on-dash is-coral" />
              <span className="on-dash is-yellow" />
              <span className="on-dash is-green" />
              <span className="on-dash is-cobalt" />
            </span>
