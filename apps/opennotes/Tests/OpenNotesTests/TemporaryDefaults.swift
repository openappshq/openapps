...
/// (openapps-updater, openapps-licensing, apps/hertz, apps/macpaper,
/// apps/opennotes); only `prefix` differs. Keep them identical otherwise.
/// OpenNotes' preview harness keeps its throwaway suite the same way
...
final class TemporaryDefaults: @unchecked Sendable {
    ...
    /// none may be.
    static let prefix = "space.openapps.opennotes."
