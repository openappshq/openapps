...
public enum NoteColorChoice: String, AppEnum {
    ...
    public static let caseDisplayRepresentations: [NoteColorChoice: DisplayRepresentation] = [
        .coral: "Coral", .yellow: "Yellow", .butter: "Butter", .mint: "Mint", .sage: "Sage", .sky: "Sky", .lagoon: "Lagoon",
        .lilac: "Lilac", .rose: "Rose", .sand: "Sand", .slate: "Slate", .graphite: "Graphite", .paper: "Paper",
    ]
