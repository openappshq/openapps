...
nonisolated public struct Hotkey: Codable, Hashable, Sendable {
    ...
    /// ⌥⌘N.
    public static let `default` = Hotkey(keyCode: 45, modifiers: [.option, .command])
    ...
    public var problem: String? {
        if Self.keyName(keyCode) == nil { return "Not a key OpenNotes can use." }
