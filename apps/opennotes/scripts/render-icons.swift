...
// Run through scripts/make-icons.sh from the app directory.
import AppKit

let fileManager = FileManager.default
let root = URL(fileURLWithPath: fileManager.currentDirectoryPath)
let assets = root.appendingPathComponent("design/assets")
let resources = root.appendingPathComponent("Sources/OpenNotes/Resources")
...
let iconset = fileManager.temporaryDirectory.appendingPathComponent("OpenNotes-\(UUID().uuidString).iconset")
